    ...
    <div class="entry-form mb-[20px] flex justify-center items-center">
        <form @submit.prevent.stop="form.post(route('register'))">
            ...
            <section class="mb-[20px]">
                <button class="mb-[20px] block">Sign Up</button>
                <template v-if="params.get('google') === 'true'">
                    <p class="mb-[20px]">or</p>
                    <a type="button" class="mb-[20px] flex items-center" :href="route('auth.google.redirect')">
                        <div class="mr-[20px]">
                            <img class="w-[40px] rounded overflow-hidden"
            ...
            <p>Already have an account?
                <Link :href="route('sign-in')" class="text-orange-400 underline">Log In</Link>
            </p>
        </form>
