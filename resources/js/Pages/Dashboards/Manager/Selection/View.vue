...
const props = defineProps(['selection', 'packages'])
...
if (props.selection.tips) {
    tips.value = JSON.parse(props.selection.tips)
}
...
function updateSelection() {
    ...
    form.patch(route('dashboard.selection.updateSelection',[props.selection.id]))
}
...
function deleteSelection() {
    ...
    form.delete(route('dashboard.selection.deleteSelection',[props.selection.id]))
}
</script>
    ...
    <DashboardLayout :page-heading="'View Selection : '" title="View Selection">
        <div class="w-[98%] flex mb-[20px] text-white items-center mx-auto gap-2.5 justify-between text-sm">
            ...
            <div class="flex gap-x-2">
                <button class="action-button bg-orange-600 hover:bg-blue-600/50 " @click="updateSelection">Update</button>
                <button class="action-button bg-red-600 hover:bg-blue-600/50 " @click="deleteSelection">Delete</button>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <table v-else>
                            ...
                            <tr v-for="tip in tips">
                                ...
                                <td>
                                    <button class="bg-red-500 text-white px-[10px] rounded-sm py-[5px]" @click.prevent="removeTip(tip.id)">Remove</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
