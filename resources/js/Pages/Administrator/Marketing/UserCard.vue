    ...
    <div class="app-panel flex justify-between mx-[20px] !py-[20px]">
        ...
        <div class="h-[150px] flex-grow-[1] px-[30px] flex flex-col justify-center">
            ...
            <ul class="text-white text-sm">
                <li class="flex py-[5px]"><p class=" w-[100px] flex justify-between">Role <span
                    class="text-right">:</span>
                </p>
                    <p class="px-[10px]">{{ user.role_name }}</p></li>
                <li class="flex py-[5px]"><p class=" w-[100px] flex justify-between">Email <span
                    class="text-right">:</span>
                </p>
                    <p class="px-[10px]">{{ user.email }}</p></li>
                <li class="flex py-[5px]"><p class=" w-[100px] flex justify-between">Phone <span
                    class="text-right">:</span>
                </p>
                    <p class="px-[10px]">{{ user.phone }}</p></li>
                <li class="flex py-[5px]"><p class=" w-[100px] flex justify-between">Status <span
                    class="text-right">:</span>
                </p>
